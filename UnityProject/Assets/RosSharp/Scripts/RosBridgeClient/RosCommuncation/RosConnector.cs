...
namespace RosSharp.RosBridgeClient
{
    public class RosConnector : MonoBehaviour
    {
        ...
        public void Reconnect() //DOESNT WORK
        {
            RosSocket.Close();
            IsConnected.Reset();
        ...
        public void ConnectAndWait()
        {
                ...
                RosStatus = "connecting to ROS";
            if (!IsConnected.WaitOne(SecondsTimeout * 1000))
            {
                Debug.LogWarning("Failed to connect to RosBridge at: " + RosBridgeServerUrl);
                RosStatus = "Failed to connect to RosBridge at: " + RosBridgeServerUrl;
                connected = false;
            }
        ...
        private void OnConnected(object sender, EventArgs e)
        {
            ...
            RosStatus = "Connected to RosBridge: " + RosBridgeServerUrl;
        }
        ...
        private void OnClosed(object sender, EventArgs e)
        {
            ...
            RosStatus = "Disconnected from RosBridge: " + RosBridgeServerUrl;
        }
    }
}
